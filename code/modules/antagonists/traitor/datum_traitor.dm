 ...
 */
/proc/give_announce_traitor_codewords(datum/antagonist/A)
	var/mob/traitor_mob = A.owner.current
	...
	A.antag_memory += "<b>Code Phrase</b>: <span class='red'>[phrases]</span><br>"
	A.antag_memory += "<b>Code Response</b>: <span class='red'>[responses]</span><br>"
