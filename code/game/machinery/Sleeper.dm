...
/obj/machinery/sleeper/proc/occupant_processing()
	processing_timer = addtimer(CALLBACK(src, .proc/occupant_processing), 20, TIMER_STOPPABLE)
	message_admins("occupant processing")
